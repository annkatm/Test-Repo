...
const StatsCards = ({ transactionStats, onBorrowedClick, onOverdueClick, onPreviousBorrowedClick }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
      ...
      <div
        ...
        onClick={onPreviousBorrowedClick}
      >
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-sm font-medium text-gray-600 mb-1">Previously Borrowed Items</h3>
            <div className="text-4xl font-bold text-gray-900">{transactionStats.previousBorrowed}</div>
          </div>
